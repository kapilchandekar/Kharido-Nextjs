...
import { useSignUpUserMutation } from "@/lib/userSlice/userSlice";
    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        >
          <div>
            ...
            <div className="mt-2">
              ...
              />
              <span className="text-pink-700">{formik.errors.name}</span>
            </div>
          </div>
          <div>
            <label
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
              <span className="text-pink-700">{formik.errors.number}</span>
            </div>
          </div>
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          Already a member{" "}
          <Link href="/login" className="font-semibold leading-6 primary-text">
            Log In
          </Link>
        </p>
      </div>
